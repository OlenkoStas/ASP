...
namespace Lesson_03.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                //Изменить на ник 
                var user = new ApplicationUser { UserName = model.NickName, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, Country = model.Country, City = model.City };
